...
const ProblemTable = ({ problems }) => {
  ...
  const totalPages = Math.ceil(filterProblems.length / itemsPerPage);
  ...
  return (
    <div className='w-full max-w-6xl mx-auto mt-10 '>
                ...
                paginatedProblems.map((problem) => {
                  ...
                  return (
                    <tr key={problem.id}>
                      ...
                      <td>
                        <span
                          className={`badge font-semibold text-xs text-white ${problem.defficulty === "EASY"
                              ? "badge-success"
      ...
      <div className='flex justify-center mt-6 gap-2'>
        ...
        >Prev</button>
        <span className='btn btn-sm'>{currentPage} of {totalPages}</span>
        <button
        className='btn btn-sm'
