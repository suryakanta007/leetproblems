    ...
    <div className='min-h-screen flex flex-col items-center mt-14 px-4'>
      ...
      </p>
      {
        problems.length >0 ? (<ProblemTable problems={problems}/>):(
            <p className='mt-10  tetx-center text-lg font-semibold text-gray-500 dark:text-gray-400 z-10 border border-primary px-4 py-2 rounded-md border-dashed'>No problems Found</p>
        )
      }
    </div>
  )
